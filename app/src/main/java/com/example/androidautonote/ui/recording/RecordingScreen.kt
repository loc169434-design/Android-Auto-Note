...
fun RecordingScreen(
    ...
    // Full display text = confirmed + partial (in progress)
        ...
        Card(
            ...
            Column(
                ...
                Row(
                        ...
                        onClick = {
                            if (isPaused) {
                                service?.let {
                                    ...
                                    // Use a simpler approach - directly toggle via service reference
                                }
                                // For simplicity, the Activity handles this through service binding
                            }
                        },
                        modifier = Modifier
                            .size(56.dp)
                    ...
                    IconButton(
                        onClick = {
                            val fullText = service?.getFullText() ?: displayText
                            onSave(fullText)
                        },
                        modifier = Modifier
                            .size(48.dp)
